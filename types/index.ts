...
export type NotificationType = 'task_assigned' | 'task_commented' | 'task_due' | 'mention' | 'vision_due' | 'access_request_approved' | 'access_request_rejected' | 'access_request_received'
