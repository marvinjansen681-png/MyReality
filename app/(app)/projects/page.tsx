      ...
      <AnimatePresence>
        {modalOpen && (
          <>
            ...
            <motion.div
              className="fixed z-50 bg-card border border-[var(--border)] bottom-0 left-0 right-0 rounded-t-2xl max-h-[90dvh] overflow-y-auto sm:bottom-auto sm:top-1/2 sm:left-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2 sm:rounded-xl sm:w-full sm:max-w-md"
